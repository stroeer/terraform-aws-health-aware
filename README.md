...
![Terraform Registry](https://img.shields.io/badge/Terraform%20Registry-0.32.0-blue.svg)](https://registry.terraform.io/modules/saefty/aws-health-aware/1.0.9) ![Terraform Version](https://img.shields.io/badge/Terraform-1.3+-green.svg)
...
*Webhook*
1. Create a new [channel](https://slack.com/help/articles/201.0.997-Create-a-channel) for events (i.e. aws_events)
